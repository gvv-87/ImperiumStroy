...
{
	/// <summary>Compositions Dump</summary>
	[PublishedContentModel("compositionsDump")]
	public partial class CompositionsDump : PublishedContentModel, IHeadingBase, IKeywordsBase, ILanguageBase, INavigatable, ISeoBase, ISitemapBase, IUrlNavigation
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "compositionsDump";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public CompositionsDump(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<CompositionsDump, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}

		///<summary>
		/// Заголовок 1 уровня: Заголовок h1 для посетителей и поисковиков
		///</summary>
		[ImplementPropertyType("seoTopHeader")]
		public string SeoTopHeader
		{
			get { return Umbraco.Web.PublishedContentModels.HeadingBase.GetSeoTopHeader(this); }
		}
		...
		{
			get { return Umbraco.Web.PublishedContentModels.KeywordsBase.GetSeoKeywords(this); }
		}

		///<summary>
		/// Страница на других языках: Ссылки на копии страницы на других языках
		///</summary>
		[ImplementPropertyType("alternativeLanguages")]
		public object AlternativeLanguages
		{
			get { return Umbraco.Web.PublishedContentModels.LanguageBase.GetAlternativeLanguages(this); }
		}
